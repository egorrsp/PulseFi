...
// Create pda-profile
export function CreateUserProfileUI({ username }: { username?: string }) {
        ...
        <div className="flex flex-col gap-16 relative">
            <div className="flex md:flex-row flex-col justify-between items-center gap-16">
                <div>
                    ...
                    <p className="text-[#111827] text-md">
                        Here you can stake your tokens
                    </p>
                </div>

                <div className="flex flex-col justify-end gap-2 border border-red-500 px-5 py-7 rounded-md hover:shadow-md shadow-red-500 transition-all duration-150">
                    <div className="flex flex-row w-full justify-between items-center">
                    ...
                    <p className="font-sans mt-3 text-center">
                        Please create your profile account to continue!
                    </p>
            ...
            <div className="w-full flex flex-col gap-5">
                ...
                <p className="font-sans text-gray-400">
                    If you have already created an account before, or if you think there
                    has been an error, please go to the
                    <span
                    ...
                    page. However, please make sure that you have selected the correct
                    wallet!
                </p>
            </div>
            ...
            <AnimatePresence>
                {isAlert && (
                    ...
                    >
                        <motion.div
                            className="bg-white rounded-2xl shadow-2xl p-8 w-[320px] text-center flex flex-col items-center"
                        ...
                        >
                            ...
                            <p className="text-gray-600 mb-6">
                                You need more SOL to create an account.
                                Please top up your wallet and try again.
                            </p>
                            <button
                                onClick={() => setIsAlert(false)}
                                className="px-6 py-2 rounded-md bg-[#2563EB] text-white hover:bg-[#1D4ED8] active:scale-95 transition-transform duration-150"
                            >
                                OK
                            </button>
                        </motion.div>
    ...
    return (
        <button
            className="w-full py-3 border-2 border-red-500 text-center rounded-md 
                ...
                hover:text-white shadow-md active:shadow-none text-2xl"
            onClick={() => router.push("/stake/unstake")}
        >
            Unstake
        </button>
    );
